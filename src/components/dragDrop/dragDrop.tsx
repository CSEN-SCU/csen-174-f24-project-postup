...
import Course from '../course';     // File 2
import Quarter from '../Quarter';   // File 3
            ...
            >
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                {quarter.courses.map((course, courseIndex) => (
                  <Draggable
                    key={course.id}
                    draggableId={course.id} // Ensure unique draggableId
                    index={courseIndex}
                  >
                    {(provided) => (
                      <li
                        ...
                        style={{
                          ...
                          userSelect: 'none', // Add userSelect for better dragging
